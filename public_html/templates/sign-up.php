...
<div id="myModal" class="modal">
	...
	<div class="modal-content">
		...
		<form #signUpForm="ngForm" name="signUpForm" id="signUpForm"
				(ngSubmit)="signUp();">
				...
				<div id="orghidden" class="collapse">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="orgname" class="form-control" id="orgname" name="orgname" placeholder="Organization Name">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="orglicense" class="form-control" id="orglicense" name="orglicense" placeholder="Organization License">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="address1" class="form-control" id="address1" name="address1" placeholder="Organization Address">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="address2" class="form-control" id="address2" name="address2" placeholder="Organization Address Continued">
						</div>
					</div>
					<!--Organization City-->
					<div class="form-group">
