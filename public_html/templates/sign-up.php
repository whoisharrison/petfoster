...
<!-- Large modal -->
<button class="btn btn-primary" data-toggle="modal" data-target="sign-up-modal">Large modal</button>

<div class="modal fade sign-up-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
	  aria-hidden="true">
